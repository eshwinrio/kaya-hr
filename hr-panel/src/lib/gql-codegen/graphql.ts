...
export type LoadAllUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', firstName: string, lastName: string, dateOfBirth: string, country: string, organization?: { __typename?: 'Organization', name: string } | null } | null> };
