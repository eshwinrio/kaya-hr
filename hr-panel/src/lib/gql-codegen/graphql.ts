...
export type PayslipListItemFragment = { __typename?: 'Payslip', id: number, netPay?: any | null, deductions?: any | null, paymentMethod?: string | null, generatedOn: any, employee: (
...
export type WeatherWidgetQueryVariables = Exact<{
  lat: Scalars['Float']['input'];
  lon: Scalars['Float']['input'];
}>;


export type WeatherWidgetQuery = { __typename?: 'Query', weatherData: { __typename?: 'CurrentConditions', pressure: number, humidity: number, dewPoint?: number | null, clouds: number, uvi?: number | null, visibility: number, rain: number, snow: number, conditionId?: number | null, main: string, description: string, temp: { __typename?: 'CurrentTemperatures', cur: number }, feelsLike: { __typename?: 'CurrentTemperatures', cur: number }, wind: { __typename?: 'WindData', speed: number, gust?: number | null, deg: number }, icon: { __typename?: 'Icon', url: string, raw: string } } };
...
export type IndexPageQuery = { __typename?: 'Query', hrDashboardIndex?: { __typename?: 'HRDashboardIndexPage', employeeCount: number, activeEmployees: Array<(
...
export type PayslipsIndexQueryVariables = Exact<{ [key: string]: never; }>;


export type PayslipsIndexQuery = { __typename?: 'Query', payslipsIndex: { __typename?: 'PayslipsIndexPage', totalPayslipCount: number, currentPeriodPayslipCount: number } };
...
export type ViewPayslipQuery = { __typename?: 'Query', payslipsView: { __typename?: 'ViewPayslipPage', id: number, generatedOn: any, invoiceUuid?: string | null, dispensedOn?: any | null, deductions?: any | null, netPay: any, paymentMethod?: string | null, paymentStatus: PaymentStatus, employee?: { __typename?: 'User', id: number, firstName: string, lastName: string } | null, clockTimes: Array<(
      { __typename?: 'ClockTime' }
...
export const IndexPageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"IndexPage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hrDashboardIndex"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"employeeCount"}},{"kind":"Field","name":{"kind":"Name","value":"activeEmployees"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserListItem"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Avatar"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"profileIconUrl"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserListItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"Avatar"}}]}}]} as unknown as DocumentNode<IndexPageQuery, IndexPageQueryVariables>;
